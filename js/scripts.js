$(document).ready(function(){
    $('.scroll-top-btn').on('click', function(event) {
      ...
      $("input[data-namel]").on("keypress", function(e) {
    ...
    //     });
        ...
        $("input.password").on("blur", function(e) {
          ...
          var pass;
          $("input.lastpassword").on("keyup", function(e) {
            var $this = $(this);
            
            if($this.val() == $this.parent().find('input.password').val()){
  ...
  function nextPrev(n) {
    ...
    if (currentTab >= x.length) {
      ...
      document.getElementById("regFormmm").submit(); 
      return false;
    }
